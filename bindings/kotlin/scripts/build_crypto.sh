...
cargo build -p ${TARGET_CRATE} ${RELEASE_FLAG} --target "aarch64-apple-darwin"
...
uniffi-bindgen generate "${SRC_ROOT}/bindings/${TARGET_CRATE}/src/olm.udl" \
  ...
  --lib-file "${BASE_TARGET_DIR}/aarch64-apple-darwin/${RELEASE_TYPE_DIR}/libmatrix_sdk_crypto_ffi.a"
