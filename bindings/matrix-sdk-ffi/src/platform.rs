...
fn setup_otlp_tracing_helper(
        ...
        let otlp_tracer =
            super::create_otlp_tracer(user, password, otlp_endpoint, client_name)?;
...
mod ios {
    ...
    pub fn setup_otlp_tracing(
        ...
        super::setup_otlp_tracing_helper(configuration, false, client_name, user, password, otlp_endpoint)
    }
}
...
mod other {
    ...
    pub fn setup_otlp_tracing(
        ...
        super::setup_otlp_tracing_helper(configuration, true, client_name, user, password, otlp_endpoint)
    }
}
...
#[cfg(not(target_os = "android"))]
#[uniffi::export]
pub fn setup_otlp_tracing(filter: String, client_name: String, user: String, password: String, otlp_endpoint: String) {
