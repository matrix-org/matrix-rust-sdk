...
use matrix_sdk::{
    ...
    encryption::{BackupDownloadStrategy, Encryption, EncryptionSettings},
...
async fn test_history_share_on_invite_downloads_backup_keys() -> Result<()> {
    ...
    // Alice attempts to decrypt the message on her second device, which should fail as she has not
    // downloaded the key from her backup.
    ...
    // ... which should trigger a download from key backup, allowing her to decrypt the message.
    ...
    // ... and should be able to access the event.
