...
fn emoji_from_index(index: u8) -> Emoji {
    ...
    */
    match index {
        0 => Emoji { code: 0, symbol: "🐶", description: "Dog" },
        1 => Emoji { code: 1, symbol: "🐱", description: "Cat" },
        2 => Emoji { code: 2, symbol: "🦁", description: "Lion" },
        3 => Emoji { code: 3, symbol: "🐎", description: "Horse" },
        4 => Emoji { code: 4, symbol: "🦄", description: "Unicorn" },
        5 => Emoji { code: 5, symbol: "🐷", description: "Pig" },
        6 => Emoji { code: 6, symbol: "🐘", description: "Elephant" },
        7 => Emoji { code: 7, symbol: "🐰", description: "Rabbit" },
        8 => Emoji { code: 8, symbol: "🐼", description: "Panda" },
        9 => Emoji { code: 9, symbol: "🐓", description: "Rooster" },
        10 => Emoji { code: 10, symbol: "🐧", description: "Penguin" },
        11 => Emoji { code: 11, symbol: "🐢", description: "Turtle" },
        12 => Emoji { code: 12, symbol: "🐟", description: "Fish" },
        13 => Emoji { code: 13, symbol: "🐙", description: "Octopus" },
        14 => Emoji { code: 14, symbol: "🦋", description: "Butterfly" },
        15 => Emoji { code: 15, symbol: "🌷", description: "Flower" },
        16 => Emoji { code: 16, symbol: "🌳", description: "Tree" },
        17 => Emoji { code: 17, symbol: "🌵", description: "Cactus" },
        18 => Emoji { code: 18, symbol: "🍄", description: "Mushroom" },
        19 => Emoji { code: 19, symbol: "🌏", description: "Globe" },
        20 => Emoji { code: 20, symbol: "🌙", description: "Moon" },
        21 => Emoji { code: 21, symbol: "☁️", description: "Cloud" },
        22 => Emoji { code: 22, symbol: "🔥", description: "Fire" },
        23 => Emoji { code: 23, symbol: "🍌", description: "Banana" },
        24 => Emoji { code: 24, symbol: "🍎", description: "Apple" },
        25 => Emoji { code: 25, symbol: "🍓", description: "Strawberry" },
        26 => Emoji { code: 26, symbol: "🌽", description: "Corn" },
        27 => Emoji { code: 27, symbol: "🍕", description: "Pizza" },
        28 => Emoji { code: 28, symbol: "🎂", description: "Cake" },
        29 => Emoji { code: 29, symbol: "❤️", description: "Heart" },
        30 => Emoji { code: 30, symbol: "😀", description: "Smiley" },
        31 => Emoji { code: 31, symbol: "🤖", description: "Robot" },
        32 => Emoji { code: 32, symbol: "🎩", description: "Hat" },
        33 => Emoji { code: 33, symbol: "👓", description: "Glasses" },
        34 => Emoji { code: 34, symbol: "🔧", description: "Spanner" },
        35 => Emoji { code: 35, symbol: "🎅", description: "Santa" },
        36 => Emoji { code: 36, symbol: "👍", description: "Thumbs Up" },
        37 => Emoji { code: 37, symbol: "☂️", description: "Umbrella" },
        38 => Emoji { code: 38, symbol: "⌛", description: "Hourglass" },
        39 => Emoji { code: 39, symbol: "⏰", description: "Clock" },
        40 => Emoji { code: 40, symbol: "🎁", description: "Gift" },
        41 => Emoji { code: 41, symbol: "💡", description: "Light Bulb" },
        42 => Emoji { code: 42, symbol: "📕", description: "Book" },
        43 => Emoji { code: 43, symbol: "✏️", description: "Pencil" },
        44 => Emoji { code: 44, symbol: "📎", description: "Paperclip" },
        45 => Emoji { code: 45, symbol: "✂️", description: "Scissors" },
        46 => Emoji { code: 46, symbol: "🔒", description: "Lock" },
        47 => Emoji { code: 47, symbol: "🔑", description: "Key" },
        48 => Emoji { code: 48, symbol: "🔨", description: "Hammer" },
        49 => Emoji { code: 49, symbol: "☎️", description: "Telephone" },
        50 => Emoji { code: 50, symbol: "🏁", description: "Flag" },
        51 => Emoji { code: 51, symbol: "🚂", description: "Train" },
        52 => Emoji { code: 52, symbol: "🚲", description: "Bicycle" },
        53 => Emoji { code: 53, symbol: "✈️", description: "Aeroplane" },
        54 => Emoji { code: 54, symbol: "🚀", description: "Rocket" },
        55 => Emoji { code: 55, symbol: "🏆", description: "Trophy" },
        56 => Emoji { code: 56, symbol: "⚽", description: "Ball" },
        57 => Emoji { code: 57, symbol: "🎸", description: "Guitar" },
        58 => Emoji { code: 58, symbol: "🎺", description: "Trumpet" },
        59 => Emoji { code: 59, symbol: "🔔", description: "Bell" },
        60 => Emoji { code: 60, symbol: "⚓", description: "Anchor" },
        61 => Emoji { code: 61, symbol: "🎧", description: "Headphones" },
        62 => Emoji { code: 62, symbol: "📁", description: "Folder" },
        63 => Emoji { code: 63, symbol: "📌", description: "Pin" },
