...
impl QrCodeData {
    ...
    pub fn from_bytes(bytes: &[u8]) -> Result<Self, LoginQrCodeDecodeError> {
        ...
        // 5. One byte for the length of the rendezvous ID, a u16 in big-endian
        //    encoding.
        ...
        if qr_type == TYPE {
            ...
            // The length here is guaranteed to be <= u8::MAX because that's the maximum
    ...
    pub fn to_bytes(&self) -> Vec<u8> {
        ...
        dbg!(rendezvous_id_len, &self.rendezvous_id);
...
mod test {
    ...
    const QR_CODE_DATA_RECIPROCATE: &[u8] = &[
        ...
        0x33, 0x2D, 0x31, 0x36, 0x31, 0x39, 0x64, 0x39, 0x38, 0x33, 0x30, 0x36, 0x36, 0x38, 0x00,
        0x20, 0x68, 0x74, 0x74, 0x70, 0x73, 0x3A, 0x2F, 0x2F, 0x6D, 0x61, 0x74, 0x72, 0x69, 0x78,
        0x2D, 0x63, 0x6C, 0x69, 0x65, 0x6E, 0x74, 0x2E, 0x6D, 0x61, 0x74, 0x72, 0x69, 0x78, 0x2E,
        0x6F, 0x72, 0x67,
    ];
    ...
    const QR_CODE_DATA_BASE64: &str = "SU9fRUxFTUVOVF9NU0M0Mzg4AwG0yzZ1QVpQ1jlnoxWX3d5jrWRFfELxjS2gN7pz9y+3PBowMUhYOUswMFExSDZLUEQ0N0VHNEcxVDNYRwAkaHR0cHM6Ly9zeW5hcHNlLW9pZGMubGFiLmVsZW1lbnQuZGV2";
