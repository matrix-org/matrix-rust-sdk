...
pub(crate) fn to_qr_code(
    ...
    // with different data modes/types. The parsers seem to assume a single data
    // type and since we start with an ASCII `MATRIX` header the rest of the
    // data gets treated as a string as well.
    //
