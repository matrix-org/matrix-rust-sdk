...
use super::{
    controller::TimelineMetadata, util::timestamp_to_date, DateDividerMode, TimelineItem,
...
mod tests {
    ...
    fn test_no_trailing_date_divider() {
        ...
        txn.push_back(meta.new_timeline_item(VirtualTimelineItem::DateDivider(timestamp_next_day)));
    ...
    fn test_read_marker_in_between_date_dividers() {
        ...
        txn.push_back(meta.new_timeline_item(event_with_ts(timestamp)));
        txn.push_back(meta.new_timeline_item(VirtualTimelineItem::DateDivider(timestamp)));
        txn.push_back(meta.new_timeline_item(VirtualTimelineItem::DateDivider(timestamp)));
        txn.push_back(meta.new_timeline_item(VirtualTimelineItem::ReadMarker));
        txn.push_back(meta.new_timeline_item(VirtualTimelineItem::DateDivider(timestamp)));
