...
mod private {
    ...
    impl RoomEventCacheState {
        ...
        pub async fn find_event(
            ...
            Ok(store
                .find_event(linked_chunk_id, event_id)
                .await?
        ...
        pub async fn find_event_with_relations(
            ...
            let linked_chunk_id = LinkedChunkId::Room(&self.room);
            let found = store.find_event(linked_chunk_id, event_id).await?;
            ...
            let mut related =
                store.find_event_relations(linked_chunk_id, event_id, filters.as_deref()).await?;
            ...
            while let Some(event_id) = stack.pop() {
                ...
                let other_related = store
                    .find_event_relations(linked_chunk_id, &event_id, filters.as_deref())
                    .await?;
