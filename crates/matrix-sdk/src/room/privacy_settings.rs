...
mod tests {
    ...
    async fn test_update_and_publish_canonical_alias_to_room_directory() {
        ...
        server
            ...
            .mount()
            .await;
        server.mock_create_room_alias().ok().mock_once().mount().await;
    ...
    async fn test_update_and_publish_canonical_alias_to_room_directory_with_previous_alias() {
        ...
        server.mock_remove_room_alias().ok().mock_once().mount().await;
    ...
    async fn test_update_and_publish_canonical_alias_when_create_alias_fails() {
        ...
        server.mock_create_room_alias().error500().mock_once().mount().await;
        ...
        server
            ...
            .mount()
            .await;
        server.mock_remove_room_alias().ok().never().mount().await;
        server
            .mock_room_send_state()
            .for_type(StateEventType::RoomCanonicalAlias)
            .ok(event_id!("$a:b.c"))
    ...
    async fn test_remove_and_delist_room_alias_with_no_previous_alias() {
        ...
        server.mock_remove_room_alias().ok().expect(0).mount().await;
