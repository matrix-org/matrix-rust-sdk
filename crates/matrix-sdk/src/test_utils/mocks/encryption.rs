...
//! Helpers to mock a server that supports the main crypto API and have a client automatically connected to that
...
///   this is important as it will set up an access token that will allow to know
///   what client is doing what request.
///
/// # Examples
///
/// ```
