...
impl GrantLoginWithScannedQrCode<'_> {
    ...
    ///
    /// It's necessary to subscribe to this to capture the checkcode in order to
    /// display it to the other device and to obtain the verification URL
    /// for consenting to the login.
