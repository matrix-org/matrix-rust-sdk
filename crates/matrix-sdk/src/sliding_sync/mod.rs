...
impl SlidingSync {
    ...
    ///
    /// This is similar to [`Self::reset_and_add_room_subscriptions`] but doesn't
    ...
    pub fn reset_and_add_room_subscriptions(
        ...
        let subscriptions_have_been_removed = !room_subscriptions.is_empty();
        room_subscriptions.clear();

        let subscriptions_have_been_added = upsert_room_subscriptions(
            &mut room_subscriptions,
            &self.inner.client,
            room_ids,
            settings,
        ...
        if cancel_in_flight_request
            && (subscriptions_have_been_removed || subscriptions_have_been_added)
        {
            self.inner.cancel_in_flight_request();
        }
    }
