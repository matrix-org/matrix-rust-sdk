...
#[cfg(doc)]
use crate::event_cache::store::media::MediaService;
use crate::{
    event_cache::store::media::{
        IgnoreMediaRetentionPolicy, MediaRetentionPolicy, MediaStoreError,
    },
...
pub trait IntoMediaStore {
    #[doc(hidden)]
    fn into_event_cache_store(self) -> Arc<DynMediaStore>;
}
