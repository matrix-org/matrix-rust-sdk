...
mod tests {
    ...
    use ruma::{
        ...
        owned_room_id, room_id, user_id, DeviceId, EventId, MilliSecondsSinceUnixEpoch,
        OwnedUserId, UserId,
    };
    ...
    use crate::{store::MemoryStore, test_utils::logged_in_base_client, RoomStateFilter};
