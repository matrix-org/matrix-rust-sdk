...
The `rtc_livekit_join` example is a skeleton that wires `matrix-sdk-rtc` with the
LiveKit connector, and is meant as a starting point for MatrixRTC call-join
flows.
